...
\todo{CZY TEN RYSUNEK MA TU BYĆ? BO JEST ZAKOMENTOWANY ALE JEST DO NIEGO ODNIESIENIE W TEKŚCIE ???} 
\begin{figure}[ht]
\centering
...
\caption{Decision tree for the states and decisions in one step (candle) in the learning nd testing phase.}
\label{fig:fig7}
\end{figure}
\FloatBarrier
