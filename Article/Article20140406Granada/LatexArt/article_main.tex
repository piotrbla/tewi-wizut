...
\title{Investment Strategy Based on Artificial Earthworm Behavior for Algotrading Application}

% a short form should be given in case it is too long for the running head
\titlerunning{Investment Strategy Based on Artificial Earthworm Behavior}
