...
\subcaption{} % Balance (relative value) in Matlab for GBPUSD [1h] in period 2013.01.09 - 2013.12.30 with fixed parameters p1-p5.
\label{fig:fig12}
\end{minipage}
\begin{minipage}{0.49\textwidth}
\centering
\includegraphics[width = \textwidth]{figures/rys13.png}
\subcaption{} % Balance (absolute value) in MetaTrader for GBPUSD [1h] in period 2013.01.09 - 2013.12.30 with fixed parameters p1-p5.
\label{fig:fig13}
\end{minipage}
...
\subcaption{} %Balance (relative value) in Matlab for GBPUSD [1h] in period 2013.01.09 - 2013.12.30 with dynamic p1-p5.
\label{fig:fig14}
\end{minipage}
\begin{minipage}{0.49\textwidth}
\centering
\includegraphics[width = \textwidth]{figures/rys15.png}
\subcaption{} %Balance (absolute value) in MetaTrader for GBPUSD [1h] in period 2013.01.09 - 2013.12.30 with dynamic p1-p5.
\label{fig:fig15}
\end{minipage}
\caption{CAPTION GOES HERE}
\end{figure}
