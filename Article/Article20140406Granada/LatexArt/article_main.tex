...
It is assumed that the time series is Si where $i = 1, 2, ...,$ and each word is a vector $Si = (O_i, H_i, L_i, C_i)$ called candle consisting of  four values: Open, High, Low and Close of time between the time t and t +1. I is the final index of word which is the last word in time series that was taken under consideration.\\
