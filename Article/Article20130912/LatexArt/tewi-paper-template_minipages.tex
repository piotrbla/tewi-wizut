...
In the second stage PSO (Particle Swarm Optimization) \cite{Kennedy}  algorithm which already has been proved useful in finding optimal strategy parameters \cite{PSOtrading} was used, searching for solutions within prescribed limits of the first stage. The objective function was to maximizing the Calmar ratio, as it was in the first step. \\
