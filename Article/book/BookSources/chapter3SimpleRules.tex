\chapter{Znaczenie prostych zasad w strategiach inwestycyjnych handlu algorytmicznego}
\label{SimpleRules} % Always give a unique label
% use \chaptermark{}
% to alter or adjust the chapter heading in the running head
\section{abstract}
\label{sec:c3abstract}
% Always give a unique label % and use \ref{<label>} for cross-references % and \cite{<label>} for bibliographic references % use \sectionmark{} to alter or adjust the section heading in the running head
...
\input{resultsChapter3Fig1EURJPY}
\input{resultsChapter3Fig2CHFJPY}
\input{resultsChapter3Fig3GBPCHF}
\input{resultsChapter3Fig4FUS500}
\input{resultsChapter3Fig5SILVER}
