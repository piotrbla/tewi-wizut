...
\centering
\includegraphics[width=0.92\textwidth]{images/S1a_chfjpy.eps}
\subcaption{Zysk - S1a}
\label{jedno}
\end{minipage}
\begin{minipage}{.49\linewidth}
\centering
\includegraphics[width=0.92\textwidth]{images/S1b_chfjpy.eps}
\subcaption{Zysk - S1b}
\label{dwu}
\end{minipage}
\\
\begin{minipage}{.49\linewidth}
\centering
\includegraphics[width=0.92\textwidth]{images/S1c_chfjpy.eps}
\subcaption{Zysk - S1c}
\label{cztero}
\end{minipage}
\begin{minipage}{.49\linewidth}
\centering
\includegraphics[width=0.92\textwidth]{images/S1d_chfjpy.eps}
\subcaption{Zysk - S1d}
\label{mansard}
\end{minipage}
\begin{minipage}{\linewidth}
\centering
\includegraphics[width=\textwidth]{images/S1s_chfjpy.eps}
\subcaption{Zysk - S1s}
\label{mansard}
\end{minipage}
