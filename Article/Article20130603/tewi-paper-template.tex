...
\indent Moreover the results prove that depending on the current market characteristics, it is possible to temporary disable some quarters from trade in order to getting better profits. Certainly parameters still should be calculated in the background, to be included in trade if market characteristic changes.
