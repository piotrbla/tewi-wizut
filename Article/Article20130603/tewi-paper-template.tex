...
\affiliation{%
  ...
  ul.Żolnierska 49, 71-210 Szczecin Poland\\
  {awilinski,pblaszynski}@wi.ps.pl, @wi.ps.pl
}
...
\centering \includegraphics[width=0.9\textwidth]{S1a.eps}
\subcaption{Profit - S1a}
\label{jedno}
\end{minipage}
\begin{minipage}{.40\linewidth}
\centering \includegraphics[width=0.9\textwidth]{S1b.eps}
\subcaption{Profit - S1b}
\label{dwu}
\end{minipage}
\\
\begin{minipage}{.40\linewidth}
\centering \includegraphics[width=0.9\textwidth]{S1c.eps}
\subcaption{Profit- S1c}
\label{cztero}
\end{minipage}
\begin{minipage}{.40\linewidth}
\centering 
\includegraphics[width=0.9\textwidth]{S1d.eps}
\subcaption{Profit - S1d}
\label{mansard}
\end{minipage}
\begin{minipage}{.8\linewidth}
\centering 
\includegraphics[width=0.9\textwidth]{S1s.eps}
\label{mansard}
\end{minipage}
...
\centering
\begin{minipage}{.40\linewidth}
\centering \includegraphics[width=0.9\textwidth]{rysunek2a.png}
\subcaption{Version a}
\label{jedno}
\end{minipage}
\begin{minipage}{.40\linewidth}
\centering \includegraphics[width=0.9\textwidth]{rysunek2b.png}
\subcaption{Version b}
\label{dwu}
\end{minipage}
\\
\begin{minipage}{.40\linewidth}
\centering \includegraphics[width=0.9\textwidth]{rysunek2c.png}
\subcaption{Version c}
\label{cztero}
\end{minipage}
\begin{minipage}{.40\linewidth}
\centering 
\includegraphics[width=0.9\textwidth]{rysunek2d.png}
\subcaption{Version d}
\label{mansard}
\end{minipage}
\begin{minipage}{.8\linewidth}
\centering 
\includegraphics[width=0.9\textwidth]{rysunek1pp.png}
\label{mansard}
\end{minipage}
