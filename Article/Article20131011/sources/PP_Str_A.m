...
Calmar = obliczCalmara(sumR1a);
Matrix = [round2(best,0.001), round2(Calmar,0.001), round2(bestmcc,0.001), bestk1, bestt1, bestl1, bestb1, bestvp1];
MatrixToLatex([file_name '_results.txt'], Matrix);

macierzA=[tp fp;fn tn];
ConfusionMatrixToLatex( [file_name '_CM.txt'], macierzA );
