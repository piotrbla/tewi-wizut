...
Calmar = obliczCalmara(sumR3a);
Matrix = [round2(best3,0.001), round2(Calmar,0.001), round2(bestmcc,0.001), bestk3, bestt3, bestl3, bestb3, bestvp3];
MatrixToLatex([file_name '_results.txt'], Matrix);

macierzC=[tp fp;fn tn];
ConfusionMatrixToLatex( [file_name '_CM.txt'], macierzC );
