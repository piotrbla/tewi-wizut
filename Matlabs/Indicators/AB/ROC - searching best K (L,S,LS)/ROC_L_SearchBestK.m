...
file_name = 'ROC_EURJPY_L_SearchBestK';
version = @ROC_L;
% file_name = 'ROC_EURJPY_L_SearchBestKv2';
% version = @ROC_Lv2;
rynek = 'EURJPY';
...
for j=k
    [profit, ~, ~, Calmar, iL] = version(C_learn,j,spread);
...
[profit, sumR, ROC_vec, Calmar,iL] = version(C_verrify,bestK,spread);
%%   WYNIKI
