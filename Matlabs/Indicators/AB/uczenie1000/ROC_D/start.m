...
eurusd221012;
file_name = ['tewiROCd' num2str(nr_testu) 'ab'];
spread = 0.0002;
...
[ zysk100, Ca100, l100] = ROCd( C, poczt, kon1, spread,...
    temp_p(1), temp_p(2), temp_p(3), temp_p(4), temp_p(5), temp_p(6));
[ zysk200, Ca200, l200] = ROCd( C, poczt, kon2, spread,...
    temp_p(1), temp_p(2), temp_p(3), temp_p(4), temp_p(5), temp_p(6));
[ zysk500, Ca500, l500] = ROCd( C, poczt, kon5, spread,...
    temp_p(1), temp_p(2), temp_p(3), temp_p(4), temp_p(5), temp_p(6));
%
