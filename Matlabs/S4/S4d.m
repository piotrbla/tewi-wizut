...
for paramDLength=49%liczba swiec wstecz do obliczenia maksimum
    ...
    for paramDVolLength=16%10:1:18;%liczba swiec wstecz do obliczenia sredniego wolumenu
        ...
        for paramDDuration=10%8:2:16; %liczba kroków wprzód do zamkniecia pozycji
            for paramDVolThreshold=-100%:100:0; %próg dla sredniego wolumenu
                for paramDBuffer=-0.0032%-0.0032:0.0032:0.0032%dla kwadrantu a i b szukamy ujemnych wartoœci, dla kwadrantów c i d dodatnich wartoœci bufora
                    for paramDSL=0.00384%spread*8:spread*4:spread*38;  %Stop Loss minimalnie mo¿e byæ równy 8*spread
