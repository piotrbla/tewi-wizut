...
incr=80; %dlugosc okresu uczacego
incrt=15; %dlugosc okresu testowego
...
kont = kon+incrt;
isTest = 1;
lastOpenPrice = 1.33419;
firstPosState = -1;

[ zyskT, CalmarT, sumzT, LongShortT, lastPosState, lastOpenPriceTest] = ...
    earthworm10fun( C, Daty, spread, poczt, kont, paropt(1), paropt(2), paropt(3), paropt(4), paropt(5), firstPosState, lastOpenPrice, isTest );%, paropt(6), paropt(7));
fprintf ('%f\n', zyskT)
