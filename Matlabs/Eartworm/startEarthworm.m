function [ testReturn, lastPosState, lastPosLearnState, lastOpenPrice, lastOpenPriceTest ] = startEarthworm( C, Daty, kk, firstPosState, firstPosLearnState, lastOpenPrice, lastOpenPriceTest)
...
incr=200; %dlugosc okresu uczacego
...
Params = [3 80; 1 40; 4 50; -0.0150 -0.0005; spread*6 spread*60 ; 3 80 ; -30 30];
...
% PSO
[ swarm, iterNum, best_l_op,best_zysk, best_calmar, lastPosLearnState, lastOpenPrice] = PSO(opcje,C, Daty, pocz,kon,spread, firstPosLearnState, lastOpenPrice);
paropt = swarm.best_position;
ldopt = best_l_op;
zyskU = best_zysk;
calmarU = best_calmar;

%[ zyskU, calmarU, paropt, sumrec, ldopt] = earthworm10opt( C, spread, pocz, kon, P1, P2, P3, P4);


%testowanie
[ zyskT, CalmarT, sumzT, LongShortT, lastPosState, lastOpenPriceTest] = earthworm10fun( C, Daty,  spread, poczt, kont, paropt(1), paropt(2), paropt(3), paropt(4), paropt(5), firstPosState, lastOpenPriceTest, 1);%, paropt(6), paropt(7));
%MJ zyskT
